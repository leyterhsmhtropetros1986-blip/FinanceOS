...
**ΞΕΚΙΝΑΕΙ ΠΑΝΤΑ με ένα από: "1900", "510", ή "1700"** (γραμμένο με στυλό στο πάνω μέρος).
Παράδειγμα έγκυρων: 1900101132, 1900101440, 5100078234, 1700005512.
ΜΗΝ επιστρέφεις αριθμούς που δεν ξεκινούν με αυτά τα τρία prefixes.
...
- invoice_number: Ο ΔΙΚΟΣ ΤΟΥ αριθμός ΑΥΤΟΥ του παραστατικού (συνήθως σε πίνακα κεφαλίδας τύπου "Σειρά / Αριθμός", πχ. TPY-S1-114344 ή απλά "918").
  ΠΡΟΣΟΧΗ: Σε ναυτιλιακά/τελωνειακά τιμολόγια υπάρχουν συχνά ΕΝΟΤΗΤΕΣ όπως "Στοιχεία Υπόθεσης" που αναφέρουν αριθμούς ΑΛΛΩΝ σχετικών παραστατικών (πχ. ένα πεδίο με ετικέτα "Τιμολόγιο: 30407Α/14-7-26" μέσα σε λίστα στοιχείων φορτίου). ΑΥΤΟ ΔΕΝ είναι ο αριθμός του παρόντος τιμολογίου — αγνόησέ το. Ο σωστός αριθμός είναι αυτός στην κύρια κεφαλίδα του εγγράφου.
- invoice_date: Η ημερομηνία ΈΚΔΟΣΗΣ αυτού του τιμολογίου (συνήθως στην κύρια κεφαλίδα, δίπλα στο "Ημερομηνία"). YYYY-MM-DD. Μην μπερδεύεις με άλλες ημερομηνίες που εμφανίζονται (τελωνειακή αναφορά, ημερομηνία άφιξης/αναχώρησης, κ.λπ.).
